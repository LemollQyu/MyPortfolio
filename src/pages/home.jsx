...
const Home = () => {
  ...
  return (
	...
	<LayoutHome>
		...
		<div className=' w-full h-3/4 md:mb-30 mb-20 '>
			<video className="w-full h-full " src={videoBg} autoPlay loop muted />
		</div>	 
		
		
	
      <h1 className="text-2xl w-full text-center md:text-4xl absolute left-1/2 bottom-16 translate-x-[-50%] md:bottom-24">
        Life is simple {' '}
		...
		<div className="absolute p-5 border rounded-full">
